...
@ScriptConfiguration.List(
    {
        @ScriptConfiguration(
            name = "Method" , 
            description = "Type of enchant to cast", 
            allowedValues = {"BOLT", "LEVEL_1", "LEVEL_2", "LEVEL_3", "LEVEL_4", "LEVEL_5", "LEVEL_6", "LEVEL_7" } ,  
            visible = true
        ),
        @ScriptConfiguration(
            name = "Item to Enchant" , 
            description = "What item do you want to enchant", 
            allowedValues = {"Please choose a method!" } ,
            visible = true
        ),
         @ScriptConfiguration(
            name = "Level to stop" , 
            description = "Stops when reaches this level", 
...
/** 
    ...
    public void methodUpdated(String newMethod) {
       switch(newMethod){
        ...
        case "BOLTS":
            String[] CrossbowBoltList = {"ONYX_DRAGON","ONYX","DRAGONSTONE_DRAGON","DRAGONSTONE","DIAMOND_DRAGON","DIAMOND","RUBY_DRAGON","RUBY",
            "TOPAZ_DRAGON","TOPAZ","EMERALD_DRAGON","EMERALD","PEARL_DRAGON","PEARL","JADE_DRAGON","JADE","SAPPHIRE_DRAGON","SAPPHIRE","OPAL_DRAGON","OPAL"};
